$(function () {
    ...
    if (data_string === "undefined" || data_string === undefined || data_string === "" || data_string === "{}") {
        li += "<li style='background-color: rgba(0, 0, 0,0);text-align: center;font-size: 30px'>该查询条件下没有结果</li>";
    } else {
