...
def get_deal():
    ...
    url1 ="http://api.money.126.net/data/feed/0000001,0601857,0601600,0601398,0600028,0600019,0601318,0600030,0601939,0601088,0600900,1002024,0600111,0600031,1000002,0601128,1002142,0600036,0600919,{},money.api?callback=_ntes_quote_callback54340146".format(code)
    ...
    info = html2.find('div', class_="compare_cont border_box").find('div', class_="title_02 wbwc_title").find_all('span')
